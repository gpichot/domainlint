...
| `packageRules` | `PackageImportRestriction[]` | — | Cross-package import restrictions for monorepos (see [Workspaces](/workspaces/#cross-package-import-rules)). |
